...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = TabellenApi()
        api_instance.get_tabel  # this is an instance of the class Endpoint
        api_instance.get_tabel()  # this invokes api_instance.get_tabel.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_tabel.callable or self.callable in this class
